...
metrics = {
    "planner": Metric(
        ...
        "Plan the implementation of PdPc professionally and systematically.\nPrepare lesson plans and determine appropriate assessment methods.\nProvide educational resources according to students' abilities, time allocation, and adherence to the instructions in force."
    ),
    "guardian": Metric(
        "Guardian",
        "img/guardian.png",
        ...
        "You fully meet the definition! Congrats!",
        "Control the learning process and learning environment in a professional and organized manner.\nManages the content of the lesson and the allocation of time given.\nProvide opportunities for active participation of students by meeting the learning objectives and according to the ability of students to learn.\nMonitor student communication and behavior.\nArrange the position of students and create an entertaining learning environment."
    ),
    "mentor": Metric(
        "Mentor",
        "img/mentor.png",
        ...
        "You fully meet the definition! Congrats!",
        "Guide students to master the content and skills based on the syllabus.\nAssist students make decisions and solve problems in learning activities."
    ),
    "motivator": Metric(
        "Motivator",
        "img/motivator.png",
        ...
        "You fully meet the definition! Congrats!",
        "Encourage students' minds and emotions in carrying out learning activities in a professional and planned manner.\nMind motivators stimulate students to communicate and collaborate by asking questions geared toward critical and creative thinking.\nEncourage students to make decisions or solve problems when learning activities are carried out.\nEmotional motivators give praise, encouragement, appreciation, and confidence as well as\nconcern for the needs of students in a prudent, comprehensive, and continuous manner."
    ),
    "assessor": Metric(
        "Assessor",
        "img/assessor.png",
        ...
        "You fully meet the definition! Congrats!",
        "Perform assessments in a systematic and planned manner. evaluators, teachers\nUse various assessment methods, conduct intervention activities, give assignments, reflect on and review student work."
    ),
}
